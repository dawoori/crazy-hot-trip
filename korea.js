...
console.log(koreaData.length);

var key = Math.floor(Math.random() * 5);
console.log(key);
console.log(koreaData[key]);

for(var value in koreaData[key]) {
    console.log(value);
    for(var si in koreaData[key][value]){
        console.log(koreaData[key][value][si]);
    }
}